...
public class NetworkConstants {
    ...
    public static final ResourceLocation TRANSFER_RECIPE_PACKET_ID = ResourceLocation.fromNamespaceAndPath(RecipeBookAccessCommon.MOD_ID, "transfer_recipe_packet");
}
